  ...
  getMore: function (page) {
    ...
    var data = {
      esId: that.data.id,
			...
			min:that.data.inpmin?that.data.inpmin:'',
			max:that.data.inpmax?that.data.inpmax:'',
		}
    ...
    var data = {
			...
			min:that.data.inpmin?that.data.inpmin*10000:'',
			max:that.data.inpmax?that.data.inpmax*10000:'',
		}

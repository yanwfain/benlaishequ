...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this;
    var url = app.globalData.host + '/new/community/getCommunityByCompany';
    let data = {
    ...
    app.wxRequest('POST', url, data, (res) => {
      ...
      if (res.success) {
        ...
        var url = app.globalData.host + '/new/community/getHoseTypeByCommunity';
        let data = {
          estateId:res.data[0].id
        };
        console.log(data)
        app.wxRequest('POST', url, data, (res) => {
          console.log(res)
  ...
  pickerProChangef1: function (e) {
    ...
    // this.data.pickerProDataf1[this.data.countryIndex1].id
  },
  ...
  submit1:function(e){
    ...
    if(!this.data.pickerProDataf1[this.data.countryIndex1].id){
      wx.showToast({
        title: '请完善信息后提交',
        icon:'none'
      })
    ...
    wx.navigateTo({
      url: '/pages/xinfangxuanze/index?houseId=' +this.data.pickerProDataf1[this.data.countryIndex1].id,
    })
    // wx.navigateTo({

...
Page({
  ...
  getMore: function (page) {
    wx.showLoading({
      title: '加载中',
		...
		var that = this;
    var url = app.globalData.host + '/new/buildResources/getResourcesUpByUser';
    var data = {
  ...
  delitFn:function(e){
    wx.navigateTo({
      url: '/pages/guanli/fangyuanguanlilistxin?id=' + e.currentTarget.dataset.id + '&businessType=' +e.currentTarget.dataset.businessType ,
    })
  },
  delitFn1:function(e){
    wx.navigateTo({
  ...
  editFn:function(e){
    wx.navigateTo({
      url: '/pages/xinfangxuanze/index?id=' + e.currentTarget.dataset.id + '&num_type=' + e.currentTarget.dataset.houseid,
    })
  ...
  submit_btn:function(e){
    if(this.data.tid==1){
      ...
      wx.navigateTo({
        url: '/pages/xinfanginp/index?num_type=' + this.data.num_type,
      })
    }
    if(this.data.tid==2){
      wx.navigateTo({
        // url: '/pages/xinfangxuanze/index',
        url: '/pages/xinfangxuanzeOne/index',
      })
    }
    this.setData({
      ishow:false
